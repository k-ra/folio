...
- `src/ai/session.ts`: provider-specific, account-scoped browser-local BYOK keys and common request transport; never persist credentials in the story model or cloud rows.
